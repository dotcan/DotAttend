...
<div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
    ...
    @if($errors->any())
        <div id="error-dismiss-btn" class="fixed bottom-0 left-1/2 transform -translate-x-1/2 z-[60] sm:max-w-4xl w-full mx-auto p-6 ml-4">
            <!-- Card -->
            <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center gap-x-5 sm:gap-x-10">
                    ...
                    <button type="button" class="inline-flex bg-gray-200 rounded-full p-3 text-gray-500 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-400" data-hs-remove-element="#error-dismiss-btn">
