<x-admin-layout subheader="Manage Schedules" :header="'Editing Schedule #' . $schedule->id">
        ...
        <form action="{{ route('admin.schedules.update', $schedule) }}" method="POST">
            ...
            <div class="flex gap-x-6 mb-6">
                @for($i=0; $i<7; $i++)
                    ...
                    <div class="flex">
                        <input type="checkbox" name="days[]" value="{{ $day }}" @checked(in_array($day, $schedule->days)) class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-checkbox-group-{{$i}}">
